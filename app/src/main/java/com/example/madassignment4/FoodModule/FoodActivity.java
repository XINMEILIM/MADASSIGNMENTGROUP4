...
public class FoodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foods0.add(new FoodBean("Stir-fried vegetables", R.mipmap.icon_vegetables, "150", R.string.stir_fried_vegetables, 143));
        foods0.add(new FoodBean("Chicken breast", R.mipmap.icon_chicken, "100", R.string.chicken_breast, 233));
        foods0.add(new FoodBean("Purple sweet potato.", R.mipmap.icon_purple_sweet_potato, "200", R.string.purple_sweet_potato, 44));
